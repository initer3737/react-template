...
export default function Modal({modalId,children,modalTitle,modalTitleIcon}:props) {
  return (
    ...
    <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable text-centered">
      <div className="modal-content text-light bg-4">
        <div className="modal-header">
          ...
          <button className="btn-close btn-close-white" data-bs-dismiss="modal" id='closeModal'/>
        </div>
